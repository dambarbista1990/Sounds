...
//  Sounds
//
//  Created by Dambar Bista on 9/24/20.
...
struct CellIdentifiers {
    ...
    static let educationCellIdentifier      =   "educationCell"
    static let technologyCellIdentifier     =   "technologyCell"
    static let fruitsCellIdentifier         =   "fruitsCell"
    static let vegetablesCellIdentifier     =   "vegetablesCell"
    static let colthsCellIdentifier         =   "clothsCell"
