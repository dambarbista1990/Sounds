...
struct AnimalModel {
    ...
    static let animalData = [
        ...
        AnimalData(name: "Duck", image: UIImage(named: "duck.jpg")!, sound: "duck"),
        AnimalData(name: "Sheep", image: UIImage(named: "sheep.jpg")!, sound: "sheep"),
        ...
        AnimalData(name: "Parrot", image: UIImage(named: "parrot.jpg")!, sound: "parrot"),
        ...
        AnimalData(name: "Cheetah", image: UIImage(named: "cheetah.jpg")!, sound: "cheetah"),
        AnimalData(name: "Chimpanzee", image: UIImage(named: "chimp.jpg")!, sound: "chimp"),
        ...
        AnimalData(name: "Hyena", image: UIImage(named: "hyena.jpg")!, sound: "hyena"),
        AnimalData(name: "Jaguar", image: UIImage(named: "jaguar.png")!, sound: "jaguar"),
        AnimalData(name: "Leopard", image: UIImage(named: "leopard.jpg")!, sound: "leopard"),
        ...
        AnimalData(name: "Racoon", image: UIImage(named: "racoon.png")!, sound: "raccon"),
        ...
        AnimalData(name: "Sea lion", image: UIImage(named: "sealion.jpg")!, sound: "sealion"),
        ...
        AnimalData(name: "Camel", image: UIImage(named: "camel.jpg")!, sound: "camel"),
