...
class FartViewController: UIViewController, UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: CellIdentifiers.fartCellIdentifier, for: indexPath) as! FartTableViewCell
        cell.fartImageView.image = FartModel.getFartImage(for: indexPath.row)
    
        cell.fartImageView.layer.cornerRadius = 6
